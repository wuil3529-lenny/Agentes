...
**Formato obligatorio:** Usa la estructura de la Plantilla de Skill (ubicada en ./resources/plantilla_skill.md) como base. Debe contener las secciones: Objetivo, Entradas/Salidas esperadas y Límites de Seguridad (Hard-Stops).
...
**Formato obligatorio:** Usa la Plantilla de Script (ubicada en ./resources/template_herramienta.py) como base. El código debe estar fuertemente tipado y contener bloques `try-except` para evitar excepciones no controladas. 

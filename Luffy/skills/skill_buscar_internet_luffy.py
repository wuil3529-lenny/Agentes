...
@tool
def tool_buscar_internet_luffy(query: str, max_results: int = 5) -> str:
    """
    Busca información en internet usando DuckDuckGo Lite.
    Útil para investigar conceptos técnicos, herramientas o plataformas que el usuario mencione durante una entrevista y que tú desconozcas.
    """
    try:

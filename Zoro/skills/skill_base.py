...
Rutas de escritura permitidas para Zoro:
  - /app/Zoro/proyectos/    (entregables)
...
_AGENTE   = "Zoro"
_TRABAJO  = _APP_ROOT / _AGENTE / "proyectos"
...
def _ruta_es_valida(ruta_str: str) -> tuple[bool, str]:
    ...
    if ruta_norm.startswith(raiz_agente):
        # Subcarpetas permitidas dentro de /app/Zoro/
        subcarpetas_ok = ["proyectos", "skills", ".agents"]
